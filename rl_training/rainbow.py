...
def main(max_epoch=MAX_EPOCH):
    ...
    log_dir = WEIGHTS_DIR.parent / "logs" / "rainbow"
    ...
    def save_best(policy):
        ...
        torch.save(policy.state_dict(), WEIGHTS_DIR / "best_rainbow.pth")
        print(f"  -> saved rl_training/weights/best_rainbow.pth")
    ...
    def save_checkpoint(epoch, env_step, gradient_step):
        if epoch % CHECKPOINT_FREQ == 0:
            ...
            path = ckpt_dir / f"rainbow_ep{epoch:04d}.pth"
